...
export const buyPremium = `🎄НОВОГОДНЯЯ АКЦИЯ🎄
Акция на премиум-подписку: 499₽ / 5.99$ на 12 месяцев
Акция продлится до 14 января 2023
...
Если есть предложение по обновлениям пишите @chatvdvoembot`;
